    ...
    footer: {
        text: (
            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                <span>MIT {new Date().getFullYear()} © <a href="https://github.com/zainulnazir" target="_blank">Zainul Nazir</a></span>
                <div style={{ display: 'flex', gap: '12px', fontSize: '0.85rem', color: 'rgba(255,255,255,0.5)' }}>
                    ...
                    <a href="https://instagram.com/zainulnazir" target="_blank" rel="noopener noreferrer" style={{ color: 'inherit' }}>Instagram</a>
                </div>
            </div>
        )
    },
